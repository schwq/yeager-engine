...
struct ExplorerObject {
    ExplorerObject(const char* name, ExplorerObjectType type, ToolBoxObject* toolbox_object = nullptr);
...
public:
    ...
    void AddObject(const char* name, ExplorerObjectType type, ToolBoxObject* toolbox_object);
    void DrawExplorer();
    ExplorerObject toolbox_selected = ExplorerObject("NONE", ExplorerObjectType::kNone);
