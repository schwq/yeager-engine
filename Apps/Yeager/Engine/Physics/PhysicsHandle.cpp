...
{
  Yeager::Log(INFO, "Creating EntityPhysics name {} ID {}", m_entity->GetName(), m_entity->GetId());
}

EntityPhysics::~EntityPhysics()
{
  Yeager::Log(INFO, "Destrorying EntityPhsics, name {}, ID {}", m_entity->GetName(), m_entity->GetId());
}
