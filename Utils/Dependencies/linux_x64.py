...
def copyLocalesToProgramFiles():
    src_dir = "Apps/Yeager/Resources/Locales"
...
def createEmptySceneTemplate():
    ...
    skybox_dst = (
        gPrivateFoldersPath + "/YeagerEngine/Templates/EmptyScene/Assets/Skybox"
    )
    sudoCopyFilesFromDir(skybox_src, skybox_dst, True)
    conf_path = "Templates/EmptyScene/Template.yml"
    conf_dst = gPrivateFoldersPath + "/YeagerEngine/Templates/EmptyScene"
    ...
    assets_dst = gPrivateFoldersPath + "/YeagerEngine/Templates/EmptyScene/Assets"
